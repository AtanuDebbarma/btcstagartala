          ...
          <div className="rounded-lg bg-white p-6 shadow-md sm:p-8 lg:p-10">
            ...
            <div className="space-y-4 text-base leading-relaxed text-gray-700 sm:text-lg">
              <p>
                ...
                diverse range of undergraduate programs in Science, Technology,
                Management, and Humanities. All courses are affiliated to
                Tripura University (A Central University) and follow the
                university's curriculum and examination pattern.
              </p>
              <p>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-base leading-relaxed text-gray-700 sm:text-lg">
                  ...
                  and <span className="font-semibold">Physiotherapy</span> with
                  other necessary subjects as per requirements and availability.
                </p>
          ...
          <div className="rounded-lg bg-white p-6 shadow-md sm:p-8 lg:p-10">
            ...
            <div className="mt-6 rounded-lg bg-yellow-50 p-4 sm:p-5">
              <p className="text-sm font-medium text-gray-800 sm:text-base">
                <span className="font-bold">Note:</span> University Registration
                and Examination Fees are to be paid separately as notified by
