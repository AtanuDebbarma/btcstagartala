      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          ...
          <div className="rounded-lg bg-white p-6 shadow-md sm:p-8 lg:p-10">
            ...
            <div className="space-y-4 text-base leading-relaxed text-gray-700 sm:text-lg">
              <p>
                ...
                premier institution affiliated to Tripura University (A Central
                University), located at Anandanagar, Agartala, West Tripura -
                799004.
              </p>
              <p>
                Established with a vision to provide quality education in
                science and technology, BTCST has been a beacon of academic
                excellence in the North East region of India. Our institution is
                committed to nurturing young minds and preparing them for the
                challenges of the modern world.
              </p>
              <p>
                We take pride in our state-of-the-art infrastructure,
                experienced faculty, and student-centric approach to education.
                Our curriculum is designed to blend theoretical knowledge with
                practical applications, ensuring our students are industry-ready
                upon graduation.
              </p>
            </div>
          </div>
        ...
        <section className="mb-12 sm:mb-16 lg:mb-20">
          <div className="rounded-lg bg-white p-6 shadow-md sm:p-8 lg:p-10">
            ...
            <div className="space-y-4 text-base leading-relaxed text-gray-700 sm:text-lg">
              <p>
                Bharatiya Vidya Bhavan is one of India's premier educational and
                cultural institutions. Founded in 1938 by Dr. K.M. Munshi, it
                has been at the forefront of promoting Indian culture and values
                through education.
              </p>
              <p>
                With its headquarters in Mumbai, Bharatiya Vidya Bhavan operates
                over 360 institutions across India and abroad, including
                schools, colleges, and cultural centers. The organization is
                committed to the synthesis of tradition and modernity in
                education.
              </p>
              <p>
                BTCST, as a part of this prestigious institution, carries
                forward the legacy of excellence and value-based education that
                Bharatiya Vidya Bhavan represents.
              </p>
            </div>
          </div>
        </section>
