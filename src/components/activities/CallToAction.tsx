      ...
      <div className="rounded-lg bg-linear-to-r from-[#3f003f] via-[#630063] to-[#900090] p-6 text-white shadow-lg sm:p-8 lg:p-10">
        <div className="text-center">
          ...
          <p className="mx-auto mb-6 max-w-3xl text-base leading-relaxed sm:text-lg">
            We encourage all students to actively participate in various
            activities and make the most of their college experience. For more
            information about upcoming events and activities, please contact the
