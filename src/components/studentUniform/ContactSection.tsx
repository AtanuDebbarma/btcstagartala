...
export function ContactSection(): React.JSX.Element {
  return (
    <section>
      <div className="rounded-lg bg-linear-to-r from-[#3f003f] via-[#630063] to-[#900090] p-6 text-white shadow-lg">
        <div className="text-center">
          <h4 className="mb-3 text-lg font-semibold sm:text-xl">
            Need More Information?
          </h4>
          <p className="mb-4 text-sm sm:text-base">
            For queries regarding uniform specifications or procurement, please
