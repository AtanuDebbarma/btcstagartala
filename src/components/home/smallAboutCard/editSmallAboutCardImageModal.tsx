...
interface Props {
  ...
  setOnHoverImage: Dispatch<SetStateAction<boolean>>;
}

export const EditSmallAboutCardImageModal = ({
  openModal,
  setOpenModal,
  selectedImage,
  setOnHoverImage,
  ...
  }, [openModal, loading, setOpenModal, setOnHoverImage]);
